...
export default function EditCategory() {
  ...
  const { id } = useParams(); 
    const [existingCategory, setExisitingCategory] = useState({});
    const [name,setName] = useState("");
    const [description,setDescription] = useState(existingCategory.name);
    ...
    useEffect(()=>{
        async function fetchCategoryData() {
            try {
              ...
              setExisitingCategory(response.data.categoryData);
             setName(name);
